...
public class PrefabAutoStitchingWindow : EditorWindow
{
    ...
    public static void OpenWindow()
    {
        ...
        m_window.titleContent.text = "自动拼接工具";
    ...
    protected void InitWindowUI()
    {
        ...
        designLabel.text = "设计图";
        selectDesignBtn.clicked += SelectDesignImgPath;
        selectDesignBtn.text = "选择路径";
        ...
        separateImageLabel.text = "切图（文件夹或图片）";
    ...
    private void SelectAssembleToolPath()
    {
        ...
        string path = EditorUtility.OpenFilePanel("选择路径", folderPath, "");
    ...
    protected void SelectDesignImgPath()
    {
        ...
        string path = EditorUtility.OpenFilePanel("选择路径", folderPath, "png");
        if (path != "")
        {
            designImgPath = path;
            int index = path.IndexOf("Assets");
