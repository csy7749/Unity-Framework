    ...
    public class PrefabCreateWindow : EditorWindow
    {
        ...
        public static void OpenWindow()
        {
            if (Selection.gameObjects.Length == 0)
            {
                ...
                EditorUtility.DisplayDialog("messageBox", message, "确定", "取消");
            }
        ...
        public static void OpenWindowFromObjList(GameObject[] objList)
        {
            ...
            m_window.titleContent.text = "新建组件";
        ...
        protected virtual void InitWindowUI()
        {
            ...
            string prefabNameString = "组件名称" + " :";
            string prefabTypeString = "组件类型" + " :";
            string prefabPathString = "组件储存位置" + " :";
            string prefabPackString = "组件生成模式" + " :";
        ...
        protected void SelectComponentPath()
        {
            if (pathInput != null)
            {
                ...
                if (path != null)
                {
                    ...
                    pathInput.onGUIHandler -= OnPathInputGUI;
                    pathInput.onGUIHandler += OnPathInputGUI;
                    //GetWindow<PrefabCreateWindow>("新建组件", false);
