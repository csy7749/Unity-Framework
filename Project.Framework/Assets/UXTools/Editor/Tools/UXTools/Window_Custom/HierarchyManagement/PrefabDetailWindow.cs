...
namespace ThunderFireUITool
{
    public class PrefabDetailWindow : EditorWindow
    {
        ...
        public static void OpenWindow(PrefabDetail prefabDetail)
        {
            ...
            _mWindow.titleContent.text = "修改节点";
        }
        public static void OpenWindow(ManagementLevel level)
        {
            ...
            _mWindow.position = new Rect((Screen.currentResolution.width - width) / 2,
                (Screen.currentResolution.height - height) / 2, width, height);
            _mWindow.titleContent.text = "新增节点";
        }
        ...
        private void Submit()
        {
            ...
            {
                EditorUtility.DisplayDialog("messageBox", "请选择一个Prefab",
                    "确定",
                    "取消");
                return;
            }
            ...
            if (HierarchyManagementEvent._prefabDetails.Find(s => s.Guid == _mGuid) != null)
            {
                ...
                {
                    EditorUtility.DisplayDialog("messageBox", "该Prefab已经被定义层级",
                        "确定",
                        "取消");
                    return;
                }
            ...
            {
                if (!EditorUtility.DisplayDialog("messageBox", "输入的标签没有加入标签列表，仍要提交？",
                        "确定",
                        "取消"))
                    return;
            }
        ...
        private TagDetail AddTag(VisualElement tagContent, string str)
        {
            ...
            {
                EditorUtility.DisplayDialog("messageBox", "添加的标签不能为空",
                    "确定",
                    "取消");
                return null;
            }
            ...
            {
                EditorUtility.DisplayDialog("messageBox", "已包含此标签",
                  "确定",
                  "取消");
                return null;
            }
