...
namespace ThunderFireUITool
{
    ...
    public class AssetItemPrefabRepository : AssetItemPrefab
    {
                ...
                case 1:
                    {
                        ...
                        {
                            menu.AddItem(new GUIContent("修改信息"), false, () => { PrefabModifyWindow.OpenWindow((GameObject)AssetObj, _refreshWindow); });
                            menu.AddItem(new GUIContent("删除"),
        ...
        public void OpenDeleteRecent()
        {
            ...
            {
                MessageTitle = "删除",
                MessageDelete = "确认从列表中删除",
                MessageDeleteLocal = "同时删除本地文件"
            };
