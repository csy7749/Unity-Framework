...
namespace UnityFramework
{
    ...
    {
        [SerializeField, HideInInspector] public bool Saved = false;

        //protected Vector3 Pos;
        [SerializeField, HideInInspector] protected Vector3 anchoredPos;
        [SerializeField, HideInInspector] public Vector2 offsetMax;
        [SerializeField, HideInInspector] public Vector2 offsetMin;
        [SerializeField, HideInInspector] public Vector2 anchorMin;
        [SerializeField, HideInInspector] public Vector2 anchorMax;
        [SerializeField, HideInInspector] public Vector2 pivot;
        [SerializeField, HideInInspector] protected Vector3 Scale;
        [SerializeField, HideInInspector] protected Vector3 Rotation;
        [SerializeField, HideInInspector] protected Vector2 Size;
