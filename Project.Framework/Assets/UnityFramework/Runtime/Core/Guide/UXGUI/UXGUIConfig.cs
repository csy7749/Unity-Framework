...
namespace UnityFramework
{
    ...
    public class UXGUIConfig : ScriptableObject
    {
        ...
        public static readonly string UXGUINeedReplaceSpritePathReplace =
            GUIPath + "Resources/Materials/need_replace.png";
        ...
        [SerializeField] private List<int> m_AvailableLanguages;
        ...
        [SerializeField] private string m_LocalizationFolder;
        ...
        [SerializeField] private string m_PreviewTablePath;
        ...
        [SerializeField] private string m_RuntimeTablePath;
        ...
        {
            get { return UXGUIConfig.LocalizationFolder + "TextLocalization.json"; }
        }
    }
}