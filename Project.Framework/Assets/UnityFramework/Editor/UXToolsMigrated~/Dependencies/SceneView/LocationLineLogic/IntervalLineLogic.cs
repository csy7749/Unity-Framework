...
namespace UnityFramework.Editor
{
    ...
    public class IntervalLineLogic : UXSingleton<IntervalLineLogic>
    {
        ...
        /// <summary>
        /// 绫讳技浜嶳ectTransform锛屽啓浜嗕竴涓柟渚挎帓搴忕殑鐗堟湰
        /// </summary>
        private struct Rect
        {
        ...
        /// <summary>
        /// Interval鐨勬牳蹇冿紝缁欏彲鑳戒骇鐢熺瓟妗堢殑鍖洪棿鎵揟ag
        /// 宸︾鐐规墦鍔?ADD)Tag锛屽彸绔偣鎵撳噺(DELETE)Tag
        /// </summary>
        private struct Tag
        {
            public enum TagType
        ...
        /// <summary>
        /// 鐢ㄦ潵浣縎ortedList鏀寔閲嶅Key鍊?
        /// </summary>
        /// <typeparam name="TKey">Key绫诲瀷</typeparam>
        ...
        /// <summary>
        /// 浣跨敤SortedList瀹炵幇浜嗕竴涓厓绱犲彲閲嶅鐨勪紭鍏堥槦鍒?
        /// </summary>
        ...
        /// 鏍稿績閫昏緫
        /// </summary>
        /// <param name="eps">eps=0琛ㄧず鍚搁檮鏈€缁堜綅缃紙闇€瑕佺敾鎻愮ず绾匡級</param>
        private void FindInterval(float eps)
        {
            ...
            // 澶勭悊SelectedObject鍦ㄦ渶鍙宠竟鐨勬儏鍐碉紝浠ｇ爜绫讳技鏈€宸﹁竟
            nowTags.Clear();
            ...
            for (int i = 0; i < m_Rects.Count; i++)
            {
                ...
                foreach (var tag in nowTags.tags.Values)
                {
                    // 璇存槑杩欐槸涓€涓猄electedObject鍦ㄤ腑闂寸殑tag
            ...
            // 澶勭悊SelectedObject鍦ㄦ渶涓婅竟鐨勬儏鍐碉紝浠ｇ爜绫讳技鏈€涓嬭竟
            nowTags.Clear();
