...
namespace UnityFramework.Editor
{
    ...
    public class GuideTargetStrokeDataEditor : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            string[] value = {"方形", "圆形"};
            strokeTypeProperty.intValue = Utils.EnumPopupLayoutEx("强调类型", typeof(StrokeType),
                strokeTypeProperty.intValue, value);
            //EditorGUILayout.PropertyField(strokeTypeProperty);
            string[] value1 = {"自定", "指定"};
            targetTypeProperty.intValue = Utils.EnumPopupLayoutEx("对象类型", typeof(TargetType),
            ...
            EditorGUILayout.PropertyField(playAnimatorProperty, new GUIContent("播放动画"));
