...
namespace UnityFramework.Editor
{
    ...
    public class UIBeginnerGuideEditor : UXSingleton<UIBeginnerGuideEditor>
    {
        ...
        private void InitData(UIBeginnerGuideData data)
        {
            ...
            customGuideRootNames["GuideTemplate"] = "新手引导面板";
            customGuideRootNames["TextWidget"] = "文字组件";
            customGuideRootNames["GestureWidget"] = "手势组件";
            customGuideRootNames["GamePadWidget"] = "手柄组件";
            customGuideRootNames["HighLightWidget"] = "镂空组件";
            customGuideRootNames["TargetStrokeWidget"] = "强调组件";
            customGuideRootNames["ArrowLineWidget"] = "连线组件";
        }
        ...
        public void Save()
        {
            ...
            if (guideHighLightData != null)
            {
                ...
                {
                    Debug.LogWarning($"Have MissingReferenceException.{e}");
                }
            }
        ...
        {
            ContextMenu.AddItem("设置为引导", false, () =>
            {
