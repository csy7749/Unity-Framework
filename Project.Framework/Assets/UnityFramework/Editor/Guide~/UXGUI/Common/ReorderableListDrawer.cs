...
namespace UnityFramework.Editor
{
    public class ReorderableListDrawer
    {
        ...
        private static ReorderableList TryGetPropertyList(SerializedProperty property, string headerName,
        ...
        private static void InitRecordListCallback(ReorderableList list, string headerName,
            Func<SerializedProperty, float> getHeight)
        {
            list.drawHeaderCallback = (Rect rect) => { GUI.Label(rect, headerName); };
        ...
        private static void DrawList(SerializedProperty property, Rect listRect, string headerName,
            Func<SerializedProperty, float> getHeight)
        {
            ReorderableList list = TryGetPropertyList(property, headerName, getHeight);

            property.isExpanded =
                EditorGUI.BeginFoldoutHeaderGroup(listRect, property.isExpanded, new GUIContent(headerName));
        ...
        public static void DrawListLayout(SerializedProperty property, string headerName,
            Func<SerializedProperty, float> getHeight)
        {
            ReorderableList list = TryGetPropertyList(property, headerName, getHeight);
            ...
            property.isExpanded =
                EditorGUI.BeginFoldoutHeaderGroup(listRect, property.isExpanded, new GUIContent(property.displayName));
            EditorGUI.EndFoldoutHeaderGroup();
