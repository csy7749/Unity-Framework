...
namespace UnityFramework.Editor
{
    public static partial class Utils
    {
        ...
        /// <returns></returns>
        public static List<MethodInfo> GetEditorMethod(System.Type editorClassType, string methodName, int paraCount = -1)
        {
        ...
        /// <param name="methodName"></param>
        /// <returns></returns>
        public static MethodInfo GetEditorMethod(System.Type editorClassType, string methodName)
        {
        ...
        public static object InvokeMethod(System.Type type, string methodName, object[] parameters = null)
        {
            if (parameters == null)
            {
        ...
        public static object GetPropertyValue(object obj, string propertyName, object[] index = null)
        {
            ...
            System.Type[] types = new System.Type[index.Length];
        ...
        public static object GetPropertyValue(System.Type type, string propertyName, object[] index = null)
        {
            if (index == null)
            {
        ...
        public static object GetFieldValue(System.Type type, string fieldName)
        {
        ...
        {
            MethodInfo GetSizeOfMainGameView = GetEditorMethod(System.Type.GetType("UnityEditor.GameView,UnityEditor"), "GetSizeOfMainGameView");
        ...
        public static string SelectFolder(bool needUnderAssets = true)
        {
            ...
            string path = EditorUtility.OpenFolderPanel("选择路径", folderPath, "");
            if (path != "")
            {
        ...
        public static string SelectFile()
        {
            ...
            string path = EditorUtility.OpenFilePanel("选择文件", filePath, "");
            if (path != "")
            {
                int index = path.IndexOf("Assets");
                if (index != -1)
        ...
        {
            string filePath = PlayerPrefs.GetString("LastParticleCheckPath");
            string path = EditorUtility.SaveFilePanel("保存", filePath, defaultName, extension);
            if (path != "")
            {
                int index = path.IndexOf("Assets");
                if (index != -1)
        ...
        public static int EnumPopupEx(Rect rect, string label, System.Type type, int enumValueIndex, string[] labels)
        {
        ...
        public static int EnumPopupLayoutEx(string label, System.Type type, int enumValueIndex, string[] labels)
        {
            int[] ints = (int[])Enum.GetValues(type);
            string[] strings = Enum.GetNames(type);
            if (labels.Length != ints.Length)
