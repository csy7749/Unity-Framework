...
namespace GameLogic.Combat
{
    ...
    public sealed class MotionComponent : Component
    {
        ...
        private void MoveFinish()
        {
            ...
            var target = CombatHelper.FindNearestEnemy(combatEntity, CampType.Player, 5f);
            if (target != null)
            {
                combatEntity.GetComponent<SpellComponent>()
                    .SpellWithTarget(combatEntity.GetComponent<SkillComponent>().IdSkills[1001],target);
            }
        }
