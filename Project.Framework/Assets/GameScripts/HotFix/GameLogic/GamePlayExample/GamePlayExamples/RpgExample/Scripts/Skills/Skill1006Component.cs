...
public class Skill1006Component : GameLogic.Component
{
...
public class SkillExecution1006Component : GameLogic.Component
{
    public Dictionary<CombatEntity, LineRenderer> EntityChannels { get; set; } = new Dictionary<CombatEntity, LineRenderer>();
    public GameLogic.GameTimer LockTimer = new GameLogic.GameTimer(2);
    ...
    public void OnBeginExecute(Entity entity)
    {
        ...
        var channelPrefab = GameModule.Resource.LoadAsset<GameObject>("Channel");
