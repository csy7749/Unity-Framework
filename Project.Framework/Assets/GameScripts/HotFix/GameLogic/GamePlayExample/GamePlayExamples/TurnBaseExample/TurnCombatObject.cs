...
public class TurnCombatObject : MonoBehaviour
{
    ...
    public void OnPreJumpTo(Entity action)
    {
        ...
        ShortcutExtensions.DOMove(jumpToAction.Creator.HeroObject.transform, targetPoint, jumpToAction.Creator.JumpToTime / 1000f).SetEase(Ease.Linear);
    ...
    {
        ShortcutExtensions.DOMove(transform, SeatPoint, CombatEntity.JumpToTime / 1000f).SetEase(Ease.Linear);
