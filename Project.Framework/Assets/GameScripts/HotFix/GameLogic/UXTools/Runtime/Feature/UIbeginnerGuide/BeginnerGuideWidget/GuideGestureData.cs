...
public class GuideGestureData : GuideWidgetData
{
    ...
    public void ShowDragEditorController()
    {
        ...
        if (startPosControllerTrans == null || endPosControllerTrans == null)
        {
            GameObject controllerPrefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/GameScripts/HotFix/GameLogic/UXTools/Res/UX-GUI-Feature/BeginnerGuide/Editor/Assets/Prefab/PosController.prefab");
