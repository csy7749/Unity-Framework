        ...
        public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
        {
            ...
            if (!useOwnPrefab.boolValue)
            {
                if (templateProperty.intValue == 0)
                {
                    ...
                    AssetDatabase.LoadAssetAtPath<GameObject>("Assets/GameScripts/HotFix/GameLogic/UXTools/Res/UX-GUI-Feature/BeginnerGuide/Resources/BeginnerGuideTemplate/GuideTemplate_Gesture.prefab");
                }
                else if (templateProperty.intValue == 1)
                {
                    prefabProperty.objectReferenceValue =
                    AssetDatabase.LoadAssetAtPath<GameObject>("Assets/GameScripts/HotFix/GameLogic/UXTools/Res/UX-GUI-Feature/BeginnerGuide/Resources/BeginnerGuideTemplate/GuideTemplate_GamePad.prefab");
                }
            }
