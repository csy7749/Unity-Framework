...
namespace ThunderFireUITool
{
    ...
    public partial class ThunderFireUIToolConfig
    {
        ...
        public static readonly string AssetsRootPath = "Assets/GameScripts/HotFix/GameLogic/UXTools/Res/";
        public static readonly string ToolsRootPath = "Assets/GameScripts/HotFix/GameLogic/UXTools/Editor/";

        public static readonly string AutoAssembleToolZipPath = "Assets/GameScripts/HotFix/GameLogic/UXTools/3rdTools/AutoAssembleTool.zip";
        public static readonly string AutoAssembleToolPath = "Assets/GameScripts/HotFix/GameLogic/UXTools/3rdTools/AutoAssembleTool.exe";
