...
namespace ThunderFireUITool
{
    ...
    public class UICommonScriptCheckWindow : EditorWindow
    {
        ...
        public static void OpenWindow()
        {
            ...
            m_window.titleContent.text = "脚本检查工具";
        ...
        private void InitWindowData()
        {
            ...
            CheckOptionString = "筛选条件";
            CheckAddOptionString = "添加筛选条件";
            CheckValueString = "按脚本变量值筛选";
            CheckExistString = "按脚本是否添加筛选";
            CheckButtonString = "查找";

            CheckResult_NameString = "Prefab";
            CheckResult_PathString = "Prefab路径";
            CheckResult_ObjectListString = "筛选结果";

            CheckComponentString = "检查脚本";
            CheckFieldString = "变量名称";
            FilterTipsString = "请选择可以添加到GameObject上的脚本";
            CompareOptionString = "比较方式";
            ModifyValueString = "修改值：";
            ModifyAllString = "全部修改";
            ModifySelectedString = "修改选中";
            ModifyString = "修改";
            UnselectedFieldString = "未选择字段";
            ModifyOption = "修改方式";
