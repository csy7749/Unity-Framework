...
namespace UnityEngine.UI
{
    ...
    public class UXScrollRectEditor : UnityEditor.UI.ScrollRectEditor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUI.BeginChangeCheck();
            EditorGUILayout.ObjectField(m_ItemCell, new GUIContent("窗格元素 "));
            if (EditorGUI.EndChangeCheck())
            {
                ResizeCellSize();
            }
            m_PreviewNum = EditorGUILayout.IntField("窗格数量 ", m_PreviewNum);
            if (EditorGUI.EndChangeCheck())
            {
            ...
            EditorGUI.BeginChangeCheck();
            m_layoutType.intValue = ThunderFireUITool.Utils.EnumPopupLayoutEx("窗格排布方式",
