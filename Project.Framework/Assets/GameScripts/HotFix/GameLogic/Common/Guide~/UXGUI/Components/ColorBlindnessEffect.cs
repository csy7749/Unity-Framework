...
namespace GameLogic.Guide
{
    public static class ColorModificationExtensions
    {
        private static Vector3[][] TRANSFORMS = new Vector3[][]
        {
            ...
            new Vector3[]
                { new Vector3(0.567f, 0.433f, 0f), new Vector3(0.558f, 0.442f, 0f), new Vector3(0f, 0.242f, 0.758f) },
            new Vector3[]
                { new Vector3(0.817f, 0.183f, 0f), new Vector3(0.333f, 0.667f, 0f), new Vector3(0f, 0.125f, 0.875f) },
            new Vector3[] { new Vector3(0.625f, 0.375f, 0f), new Vector3(0.7f, 0.3f, 0f), new Vector3(0f, 0.3f, 0.7f) },
            new Vector3[]
                { new Vector3(0.8f, 0.2f, 0f), new Vector3(0.258f, 0.742f, 0f), new Vector3(0f, 0.142f, 0.858f) },
            new Vector3[]
                { new Vector3(0.95f, 0.05f, 0f), new Vector3(0f, 0.433f, 0.567f), new Vector3(0f, 0.475f, 0.525f) },
            new Vector3[]
                { new Vector3(0.967f, 0.033f, 0f), new Vector3(0f, 0.733f, 0.267f), new Vector3(0f, 0.183f, 0.817f) },
            new Vector3[]
            {
                new Vector3(0.299f, 0.587f, 0.114f), new Vector3(0.299f, 0.587f, 0.114f),
                new Vector3(0.299f, 0.587f, 0.114f)
            },
            new Vector3[]
            {
                new Vector3(0.618f, 0.320f, 0.062f), new Vector3(0.163f, 0.775f, 0.062f),
                new Vector3(0.163f, 0.320f, 0.516f)
            },
        };

        public static Vector3 RedCoefficients(this ColorModification mode)
        {
            return TRANSFORMS[(int)mode][0];
        }

        public static Vector3 BlueCoefficients(this ColorModification mode)
        {
            return TRANSFORMS[(int)mode][1];
        }
