...
namespace GameLogic.Guide
{
    public class UIBeginnerGuide : UIBeginnerGuideBase
    {
        ...
        [HideInInspector] public List<Transform> customObjects;
        ...
        private void InitCustomObject()
        {
            ...
            {
                Dictionary<string, string> transformDatas =
                    JsonUtilityEx.FromJson<string, string>(guideData.CustomTransformDatas);
            ...
            if (!string.IsNullOrEmpty(guideData.CustomTextDatas))
            {
                Dictionary<string, string>
                    textDatas = JsonUtilityEx.FromJson<string, string>(guideData.CustomTextDatas);
            ...
            {
                Dictionary<string, string> imageDatas =
                    JsonUtilityEx.FromJson<string, string>(guideData.CustomImageDatas);
            ...
            {
                Dictionary<string, string> imageSprite =
                    JsonUtilityEx.FromJson<string, string>(guideData.CustomImagesprite);
