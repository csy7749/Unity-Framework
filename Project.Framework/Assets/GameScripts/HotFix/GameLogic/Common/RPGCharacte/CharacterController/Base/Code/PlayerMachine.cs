...
//Example implementation of the SuperStateMachine and SuperCharacterController
    ...
    public class PlayerMachine : SuperStateMachine
    {
        ...
        protected override void EarlyGlobalSuperUpdate()
        {
            ...
            lookDirection =
                Quaternion.AngleAxis(input.Current.MouseInput.x * (controller.deltaTime / Time.deltaTime),
                    controller.up) * lookDirection;
        ...
        void Walk_SuperUpdate()
        {
            ...
            if (input.Current.MoveInput != Vector3.zero)
            {
                moveDirection = Vector3.MoveTowards(moveDirection, LocalMovement() * WalkSpeed,
                    WalkAcceleration * controller.deltaTime);
            }
            else
            {
                currentState = PlayerStates.Idle;
        ...
        void Jump_SuperUpdate()
        {
            ...
            planarMoveDirection = Vector3.MoveTowards(planarMoveDirection, LocalMovement() * WalkSpeed,
                JumpAcceleration * controller.deltaTime);
