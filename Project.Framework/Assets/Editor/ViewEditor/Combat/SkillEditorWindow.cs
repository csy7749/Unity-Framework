...
public class SkillEditorWindow : OdinMenuEditorWindow
{
    ...
    protected override OdinMenuTree BuildMenuTree()
    {
        ...
        var configsPrefab = AssetDatabase.LoadAssetAtPath<GameObject>("Assets/AssetRaw/DefaultPackage/Ability/Configs.prefab");
        ...
        if (configsCollector != null)
        {
            ...
            var configTypeName = $"GameLogic.AbilityConfig";
            var configType = assembly.GetType(configTypeName);
            var typeName = $"GameLogic.AbilityConfigCategory";
            var configCategoryType = assembly.GetType(typeName);
            var configCategory = Activator.CreateInstance(configCategoryType) as GameLogic.AbilityConfigCategory;
