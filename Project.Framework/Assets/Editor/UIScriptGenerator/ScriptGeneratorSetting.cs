...
namespace UnityFramework.Editor.UI
{
    ...
    [CreateAssetMenu(menuName = "UnityFramework/ScriptGeneratorSetting", fileName = "ScriptGeneratorSetting")]
    public class ScriptGeneratorSetting : ScriptableObject
    {
        ...
        [SerializeField]
        private string _codePath = "Assets/GameScripts/HotFix/GameLogic/AutoGeneratedUI";

        [SerializeField]
        private string _templateRoot = "Assets/Editor/UIScriptGenerator/Template";

        [SerializeField]
        private string _scriptableDatabaseRoot = "Assets/Editor/UIScriptGenerator/Databases";
        ...
        public string ScriptableDatabaseRoot => _scriptableDatabaseRoot;
        ...
        [MenuItem("UnityFramework/Create ScriptGeneratorSetting")]
        ...
        public static string GetResolvedCodePath()
        {
            var codePath = GetCodePath();
            return string.IsNullOrWhiteSpace(codePath) ? "Assets/GameScripts/HotFix/GameLogic/AutoGeneratedUI" : codePath;
        }
        ...
        public static string GetTemplateRoot()
        {
            if (Instance == null)
            {
                return "Assets/Editor/UIScriptGenerator/Template";
            }

            if (string.IsNullOrWhiteSpace(Instance.TemplateRoot))
            {
                return "Assets/Editor/UIScriptGenerator/Template";
            }

            return Instance.TemplateRoot;
        }

        public static string GetScriptableDatabaseRoot()
        {
            if (Instance == null)
            {
                return "Assets/Editor/UIScriptGenerator/Databases";
            }

            if (string.IsNullOrWhiteSpace(Instance.ScriptableDatabaseRoot))
            {
                return "Assets/Editor/UIScriptGenerator/Databases";
            }

            return Instance.ScriptableDatabaseRoot;
        }
    }
}
