...
namespace UnityFramework.Editor
{
    ...
    public class ExcelExporterEditor: EditorWindow
    {
        ...
        private void OnGUI()
        {
            try
            {
                const string clientPath = "./Assets/AssetRaw/DefaultPackage/Configs/Ability";
                ...
                if (GUILayout.Button("导出客户端配置"))
                {
                    ...
                    ExportAllClass(@"./Assets/GameScripts/HotFix/GameLogic/EGamePlay/Config", "namespace GameLogic\n{\n");//using MongoDB.Bson.Serialization.Attributes;\n\n
